...
\char`\"{}taxtypes\char`\"{} \+: Types of vocabularies to get (\char`\"{}curriculum\char`\"{}, \char`\"{}itsv\char`\"{} and/or \char`\"{}specialisation\char`\"{}) &Returns a list of all curricula currently published (weight below 0), like \hyperlink{index_list}{list.\+php} \\\cline{1-4}
...
Thus, all our hooks are prefixed with \char`\"{}stukowin\+\_\+\char`\"{} and are commented with \char`\"{}\+Implements hook\+\_\+$\ast$\char`\"{}. The following hooks are implemented\+:
\begin{DoxyItemize}
