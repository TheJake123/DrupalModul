    ...
    function(editor) {
        return {
            ...
            onOk: function() {
                ...
                plusIcon.setAttribute('src', 
                    drupal_root + "sites/all/modules/stukowin/images/Plus.png");
                plusIcon.setStyle('width', '3em');
                plusIcon.setStyle('height', '3em');

                var minusIcon = new CKEDITOR.dom.element('img');
                minusIcon.setAttribute('src',
                    drupal_root + "sites/all/modules/stukowin/images/Minus.png");
                minusIcon.setStyle('width', '3em');
                minusIcon.setStyle('height', '3em');

                var vorIcon = new CKEDITOR.dom.element('img');
                vorIcon.setAttribute('src',
                    drupal_root + "sites/all/modules/stukowin/images/Voraussetzung.png");
                vorIcon.setStyle('width', '3em');
                vorIcon.setStyle('height', '3em');

                var empfIcon = new CKEDITOR.dom.element('img');
                empfIcon.setAttribute('src',
                    drupal_root + "sites/all/modules/stukowin/images/Empfohlen.png");
                empfIcon.setStyle('width', '3em');
                empfIcon.setStyle('height', '3em');

                var ectsIcon = new CKEDITOR.dom.element('img');
                ectsIcon.setAttribute('src',
                    drupal_root + "sites/all/modules/stukowin/images/ECTS.png");
                ectsIcon.setStyle('width', '3em');
                ectsIcon.setStyle('height', '3em');

                var voIcon = new CKEDITOR.dom.element('img');
                voIcon.setAttribute('src',
                    drupal_root + "sites/all/modules/stukowin/images/V300.png");
